...
menu_GUE_Soldier_MG = [
	[["Ammunition",577],["Clothing",575],["Helicopter Armed",512],["Military Armed",569],["Trucks Armed",534],["Weapons",627],["Money",700],["Chinnok",9003]],
	[],
	"hostile"
];
menu_Worker2 = [
...
menu_BAF_Soldier_EN_MTP = [
	[["Hind",9000],["Apache",9001],["KA - Armed",9002]],
	[],
	"Villain"
];
